...
사용자 데이터 분석을 통한 문제 정의, 서비스 로직·데이터 구조 설계, 프로토타입 구현까지 — 분석에 그치지 않고 실제로 쓰일 수 있는 형태로의 완성을 지향함
...
### ✨ Summary
- 🔭 사용자 행동 데이터 기반 추천 시스템(ThinkGood) 세그먼트 로직 및 DB 스키마 설계
- 🌱 SQL·통계 기초 역량 강화 중
- 🏆 국가데이터처 청년인턴 성과 발표회 대상, AI 오류 발굴 대회 장려상 수상
- 📫 이메일 연락 환영
...
<img src="https://github-readme-stats.vercel.app/api?username=jjhuiyaho&show_icons=true&hide_border=true&bg_color=00000000&title_color=00462A&icon_color=8CB86E&text_color=333333" height="150" alt="GitHub Stats" />
