...
### 데이터를 프로덕트로 구체화하는 한재희입니다.

데이터로 문제를 정의하고 객관적 근거를 마련하여, 이를 실행 가능한 서비스 로직과 데이터베이스 구조로 설계합니다. 단편적인 분석에 그치지 않고 실제 의사결정에 적용할 수 있는 형태로 완성합니다.
...
### ✨ Summary
- 🔭 **Focus:** 유저 행동 기반 추천 로직 설계 및 DB 스키마 재구축, LLM 환각(Hallucination) 리스크 제어
- 💡 **Action:** 다변량 통계 기반 공간·타겟 분석 및 프로토타입(Streamlit)을 통한 빠른 가설 검증
- 🏆 **Awards:** 국가데이터처 정책 제안 성과발표회 **대상**, 통계 분야 AI 오류 발굴 대회 **장려상**
